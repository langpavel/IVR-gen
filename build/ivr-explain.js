    ...
    parse: function(input, startRule) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result6 !== null) {
                            ...
                            if (result11 !== null) {
                              ...
                              if (result12 !== null) {
                                ...
                                if (result13 !== null) {
                                  ...
                                  if (result14 !== null) {
                                    result8 = [result8, result9, result10, result11, result12, result13, result14];
                                  } else {
                                    result8 = null;
                                    pos = pos3;
                                  }
                      ...
                      if (result8 !== null) {
                        result8 = (function(offset, e, s) {return [e,s]; })(pos2, result8[2], result8[6]);
                      }
                      if (result8 === null) {
                        pos = pos2;
                      }
                      ...
                      if (result7 !== null) {
                        ...
                        if (result8 !== null) {
                          result8 = (function(offset, s) {return s; })(pos2, result8[2]);
                        }
                        if (result8 === null) {
                          pos = pos2;
                        }
        ...
        if (result0 !== null) {
          result0 = (function(offset, expr, th, elsif, els) {
              return "if (" + expr + ") then {" + indent(th) + "}" +
                ...
                (els ? " else {" + els.join(', ') + "}" : '');
            })(pos0, result0[2], result0[6], result0[7], result0[8]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_SIMPLE_STATEMENT() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, label) { return "mark next instruction with label " + label })(pos0, result0[2]);
          }
          if (result0 === null) {
            pos = pos0;
          }
                ...
                if (result0 === null) {
                  ...
                  if (result0 === null) {
                    ...
                    if (result0 === null) {
                      ...
                      if (result0 !== null) {
                        result0 = (function(offset, t) { return "wait " + t + " seconds"; })(pos0, result0[2]);
                      }
                      if (result0 === null) {
                        pos = pos0;
                      }
                      if (result0 === null) {
                        ...
                        if (result0 !== null) {
                          result0 = (function(offset, str) { return "say " + JSON.stringify(str); })(pos0, result0[1]);
                        }
                        if (result0 === null) {
                          pos = pos0;
                        }
